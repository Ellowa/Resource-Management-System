    ...
    public partial class createdDB : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AdditionalRoles", x => x.Id);
                })
                .Annotation("MySQL:Charset", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    JwtRefreshToken = table.Column<string>(type: "longtext", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Users_AdditionalRoles_RoleId",
                        column: x => x.RoleId,
                        principalTable: "AdditionalRoles",
                        principalColumn: "Id",
